    ...
    <div className="flex min-h-screen bg-[#070708]">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-12 space-y-5">
            {[
              ...
              return (
                <div key={i} className="flex items-center gap-4 group animate-fade-in-delay-1">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm animate-fade-in">
          ...
          {error && (
            <div className="mb-6 p-3.5 bg-red-950/30 border border-red-900/50 text-red-400 text-xs rounded-xl flex items-center gap-2 animate-shake">
